(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react")) : typeof define === "function" && define.amd ? define(["exports", "react"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.h5table = {}, global.React));
  ...
  const H5TableHeader = require$$0.forwardRef(function H5TableHeader2({ height = 60, column, rootValue, handleHeadSortClick }, ref) {
    const [sortStatus, setSortStatus] = require$$0.useState(
      {}
    );
  ...
  function useDebounce(fn, delay) {
    const timerRef = require$$0.useRef(null);
    const debounce = (...args) => {
      if (timerRef.current) {
  ...
  function useTouchMoveLeftAndRight(target, options) {
    const distanceRef = require$$0.useRef({ distanceX: 0, distanceY: 0 });
    const start = require$$0.useRef({
      x: 0,
      y: 0
    });
    const end = require$$0.useRef({
      x: 0,
      y: 0
    });
    require$$0.useEffect(() => {
  ...
  function useScroll(target, handleScroll) {
    const handleScrollBase = require$$0.useCallback(() => {
      handleScroll();
    }, [handleScroll]);
    require$$0.useEffect(() => {
  ...
  function useGetTransformX(target, tableWidth, tableContentWidth, disable, bottomLoadEvent, offset, handleTransform, stopPropagation = true) {
    const previousXRef = require$$0.useRef(0);
    const transformXRef = require$$0.useRef(0);
    const resetMove = () => {
    ...
    const touchmove = require$$0.useCallback(
  ...
  function useCalculateTableSize(tableRef, rowHeight, showRowNum, minTableHeight, rootValue, column) {
    const [tableWidth, setTableWidth] = require$$0.useState(0);
    const [tableContentWidth, setTableContentWidth] = require$$0.useState(0);
    const tableHeight = require$$0.useMemo(() => {
  ...
  function H5Table({
    ...
    const tableRef = require$$0.useRef();
    const tableHeaderRef = require$$0.useRef();
    const tableContentRef = require$$0.useRef();
    ...
    const [moreMark, setMoreMark] = require$$0.useState(false);
    const [moveShadow, setMoveShadow] = require$$0.useState(false);
    const [clickIndex, setClickIndex] = require$$0.useState(-1);
    ...
    const loadingText = require$$0.useMemo(() => {
      let str = "";
      if (pullDownProps.loading) {
  ...
  function useHandleMove(list, options) {
    ...
    const previousXRef = require$$0.useRef(0);
    const transformXRef = require$$0.useRef(0);
    const [translateY, setTranslateY] = require$$0.useState(0);
    const [targetList, setTargetList] = require$$0.useState(
      []
    );
    const resetMove = () => {
      previousXRef.current = 0;
  ...
  const H5VirtualTableComponent = require$$0.forwardRef(H5VirtualTable);
  exports2.H5Table = H5Table;
  exports2.H5VirtualTable = H5VirtualTableComponent;
